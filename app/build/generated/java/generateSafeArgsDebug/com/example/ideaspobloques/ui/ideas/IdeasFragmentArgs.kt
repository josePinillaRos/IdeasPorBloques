...
public data class IdeasFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): IdeasFragmentArgs {
      bundle.setClassLoader(IdeasFragmentArgs::class.java.classLoader)
      ...
      return IdeasFragmentArgs(__categoryId, __categoryName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): IdeasFragmentArgs {
      val __categoryId : Int?
